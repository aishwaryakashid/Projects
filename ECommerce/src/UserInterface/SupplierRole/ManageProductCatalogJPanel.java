...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
 ...
 //   Person supplier;
    ...
    private void initComponents() {
        ...
        prieviewSaleJBtn = new javax.swing.JButton();
        ...
        prieviewSaleJBtn.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        prieviewSaleJBtn.setText("Prieview Sales>>");
        prieviewSaleJBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                prieviewSaleJBtnActionPerformed(evt);
            }
        });
        add(prieviewSaleJBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 430, 220, 40));
    ...
    private void prieviewSaleJBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_prieviewSaleJBtnActionPerformed
        // TODO add your handling code here:

        PreviewSales previewss = new PreviewSales(userProcessContainer, supplier.getProductCatalog());
        userProcessContainer.add("PreviewSales", previewss);
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
        layout.next(userProcessContainer);

    }//GEN-LAST:event_prieviewSaleJBtnActionPerformed
    ...
    private javax.swing.JButton prieviewSaleJBtn;
