...
public class CreateNewProductJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        AvaiblityLbl = new javax.swing.JLabel();
        availabilityJTxt = new javax.swing.JTextField();
        ...
        AvaiblityLbl.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        AvaiblityLbl.setText("Availability:");
        add(AvaiblityLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 240, 110, 30));

        availabilityJTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                availabilityJTxtActionPerformed(evt);
            }
        });
        add(availabilityJTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 240, 160, 30));
    ...
    // TODO add your handling code here:
        ...
        String productName = nameField1.getText().trim();
  if(productName.length() == 0 | productName == null )
        ...
        JOptionPane.showMessageDialog(null,"Please enter a Product Name");
            ...
            int availability = Integer.parseInt(availabilityJTxt.getText());
            product.setAvailability(availability);
            product.setInitialAvail(availability);
     ...
     JOptionPane.showMessageDialog(null, "Please insert Integer value for Price");
 }
    ...
    private void availabilityJTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_availabilityJTxtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_availabilityJTxtActionPerformed
   
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel AvaiblityLbl;
    private javax.swing.JTextField availabilityJTxt;
